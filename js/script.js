export const translations = {
    fr: {
        ...
        nav_recommendation: "Lettre de recommandation",
        nav_contact: "Contact",
        ...
        p_mario_desc: "Réalisation d'un niveau de Mario en utilisant des tableaux 2D, avec un système de mouvement innovant basé sur la manipulation de matrices ainsi que la génération de tableaux 2D par compréhension d'images.",
        ...
        p_short_desc: "Projet d'application servant à couper de longues vidéos en petites vidéos au format 9/16 avec tkinter, python et cuda pour utiliser la puissance des GPU nvidia et le multiprocessing.",
        ...
        p_cloud_desc1: "Projet d'application de sauvegarde de dossiers sécurisés par login, contenant des documents.",
        ...
        p_unreal_desc: "Projet débuté en 2022 pour découvrir le blueprint. Ce projet se concentre sur la création d'un système de barre de vie(nombre de coeurs) et d'un personnage qui fait de l'escalade sur tout type de structures.",
        p_yt_title: "Youtube Uploader",
        p_yt_desc: "Ce code est un script python qui permet de mettre en ligne des vidéos sur youtube. Il utilise l'api officielle de youtube et un projet google cloud pour se connecter directement au compte youtube de l'utilisateur et pouvoir uploader des vidéos.",
        p_tiktok_title: "TikTok Creation Upload",
        p_tiktok_desc: "C'est un script python qui va à l'aide de hashtags télécharger des vidéos tiktok et programmer des publications sur une durée de 10 jours.",
        ...
        moti_p3: "Mon ambition est d'exercer le métier de Gameplay Programmer. Ce rôle représente pour moi l'opportunité de combiner technique et design, en participant concrètement à la réalisation du jeu et en donnant vie aux intentions du Game Design.",
        moti_p4: "J'ai pu confirmer cette vocation à travers divers projets et expériences, notamment lors de la Summer School d'ISART Digital en juillet 2024. Aujourd'hui, je m'investis pleinement dans mes études et mes projets, avec la volonté de progresser constamment et de contribuer à la création d'expériences de jeu innovantes.",
    ...
    en: {
        ...
        nav_cv: "CV",
        nav_motivation: "Motivations",
        nav_recommendation: "Recommendation Letter",
        nav_contact: "Contact",
        ...
        p_mario_desc: "Creation of a Mario level using 2D arrays, with an innovative movement system based on matrix manipulation as well as 2D array generation by image comprehension.",
        p_zelda_title: "Zelda Remake",
        p_zelda_desc: "Recreation of Link's Awakening on Unity with combat system, inventory, and JSON save, inventory system and weapon swapping like in Zelda.",
        p_short_title: "Short Creation",
        p_short_desc: "Application project used to cut long videos into small videos in 9/16 format with tkinter, python, and cuda to use the power of nvidia GPUs and multiprocessing.",
        p_isart_title: "ISART Summer School Project",
        ...
        p_unreal_title: "Unreal Engine Project",
        p_unreal_desc: "Project started in 2022 to discover blueprints. This project focuses on creating a health bar system (number of hearts) and a character that climbs on all types of structures.",
        p_yt_title: "Youtube Uploader",
        p_yt_desc: "This code is a python script that allows uploading videos to youtube. It uses the official youtube api and a google cloud project to connect directly to the user's youtube account and be able to upload videos.",
        p_tiktok_title: "TikTok Creation Upload",
        p_tiktok_desc: "It is a python script that uses hashtags to download tiktok videos and schedule posts over a period of 10 days.",
        p_godot_title: "Peach Multiplayer in Godot",
        ...
        moti_p3: "My ambition is to work as a Gameplay Programmer. This role represents for me the opportunity to combine technique and design, by concretely participating in the realization of the game and bringing to life the intentions of Game Design.",
        moti_p4: "I was able to confirm this vocation through various projects and experiences, notably during the ISART Digital Summer School in July 2024. Today, I am fully invested in my studies and projects, with the will to constantly progress and contribute to the creation of innovative game experiences.",
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Récupérer la langue stockée ou par défaut 'fr'
    let currentLang = localStorage.getItem('lang') || 'fr';

    function setLanguage(lang) {
        document.documentElement.lang = lang;
        // Met à jour le texte du bouton (affiche la langue inverse pour inciter au changement)
        langToggle.textContent = lang === 'fr' ? 'EN' : 'FR';
        localStorage.setItem('lang', lang);
        
        // Logique pour remplacer les textes
